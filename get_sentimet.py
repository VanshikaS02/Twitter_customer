import torch
import torchtext
#from torchtext import torchtext.legacy
...
#from your_module import sentiments
...
def generate_sentiments(df):
    ...
    with open(r"C:\Users\vansh\Desktop\Twitter_customer\TEXT.Field","rb")as f:
     TEXT=dill.load(f)
...
if __name__ == '__main__':
    ...
    predictions = generate_sentiments(df)
